...
export class BestIcon extends Component {
	render() {
		let style = Object.assign({
			verticalAlign: 'middle'
		}, this.props.style);
		return (
			<svg {...this.props} viewBox="0 0 64 64" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class Heart2Icon extends Component {
	render() {
		let style = Object.assign({
...
// <path fill="none" stroke="#000" stroke-width="3" stroke-miterlimit="10" d="M44.5,6.5c-6.7,0-10.8,5.4-12.5,8.8
//    c-1.6-3.5-5.6-8.8-12.4-8.8C9.3,6.5,1,12.1,1,25.9c0,13.3,21.8,26,27.7,29.6l3.4,2.1l3.4-2.1C39.5,52.9,63,39.7,63,25.9
//    C63,13,54.7,6.5,44.5,6.5z"/>

export class FAQIcon extends Component {
	render() {
		let style = Object.assign({
			verticalAlign: 'middle'
		}, this.props.style);
...
export class ReturnIcon extends Component {
	render() {
		let style = Object.assign({
			verticalAlign: 'middle'
		}, this.props.style);
...
export class MenuArrowIcon extends Component {
	render() {
		let style = Object.assign({
			width:'48px',
			height:'48px',
		...
		return (
			<svg {...this.props} viewBox="0 0 48 48" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class LupaIcon extends Component {
	render() {
		let style = Object.assign({
			width:'30px',
			height:'30px',
...
export class CheckBoxIcon extends Component {
	render() {
		let style = Object.assign({
			width:'20px',
			height:'20px',
		...
		return (
			<svg {...this.props} viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class Caret extends Component {
	render() {
		...
		return (
			<svg {...this.props} viewBox="0 0 15 8" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class Caret2 extends Component {
	render() {
			let style = Object.assign({
				verticalAlign: 'top'
			}, this.props.style);
...
export class FilterTabBtn1 extends Component {
	render() {
		let style = Object.assign({
			width:'117px',
			height:'30px',
		...
		return (
			<svg {...this.props} viewBox="0 0 117 30" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class FilterTabBtn2 extends Component {
	render() {
		let style = Object.assign({
			width:'117px',
			height:'30px',
...
export class MenuFilterTab1 extends Component {
	render() {
		let style = Object.assign({
			width:'400px',
			height:'40px',
		...
		return (
			<svg {...this.props} viewBox="0 0 400 40" preserveAspectRatio="xMidYMid meet" style={style}>
				<g>
...
export class MenuFilterTab2 extends Component {
	render() {
		let style = Object.assign({
			width:'400px',
			height:'40px',
...
export class LupaIcon1 extends Component {
	render() {
		return (
			<SvgIcon {...this.props} viewBox="0 0 64 64" preserveAspectRatio="xMidYMid meet">
				<g>
					<path d="M37.5,4C25.1,4,15,14.1,15,26.5c0,5.1,1.7,9.7,4.5,13.5L5,54.4l0,0c-0.6,0.6-1,1.4-1,2.3C4,58.6,5.4,60,7.2,60
						c0.9,0,1.7-0.4,2.3-1l0,0L24,44.5c3.8,2.8,8.4,4.5,13.5,4.5C49.9,49,60,38.9,60,26.5C60,14.1,49.9,4,37.5,4z M37.5,42.6
						c-8.9,0-16.1-7.2-16.1-16.1c0-8.9,7.2-16.1,16.1-16.1c8.9,0,16.1,7.2,16.1,16.1C53.6,35.4,46.4,42.6,37.5,42.6z"/>
...
export class ZoomPlusIcon extends Component {
	render() {
		return (
			<SvgIcon {...this.props} viewBox="0 0 64 64" preserveAspectRatio="xMidYMid meet">
				<g>
...
export class Tire extends Component {
	...
	//       case '1':
	//          this.setState({ color1: '#ff4500', color2: '#666', color3: '#666' });
	//       break;
	//       case '2':
	//          this.setState({ color2: '#ff4500', color1: '#666', color3: '#666' });
	//       break;
	//       case '3':
	//          this.setState({ color3: '#ff4500', color2: '#666', color1: '#666' });
	//       break;
	//       default:
	//          this.setState({ color1: '#666', color2: '#666', color3: '#666' });
	//    }
	// }
	...
	render() {
		...
		return (
			<SvgIcon viewBox="0 0 210 60" x="0" y="0" id="tire" style={this.props.style}>
...
//export { Caret, FilterTabBtn1, FilterTabBtn2, LupaIcon1, Tire, CheckBoxIcon, LupaIcon, MenuFilterTab1, MenuFilterTab2, MenuArrowIcon, MenuIcon };
